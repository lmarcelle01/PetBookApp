...
namespace PetBookApp.Helpers
{
    public static class Constants
    {
        ...
        public static Uri GoToGettingStartedPage = new Uri("GettingStartedPage", UriKind.Relative);
        ...
        public static Uri GoToOnBoardingPage = new Uri("OnBoardingPage", UriKind.Relative);
